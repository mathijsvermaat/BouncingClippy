...
class BouncingClippy:
    ...
    def send_message(self, user_prompt: str) -> str:
        ...
        try:
            ...
            # Foundry project endpoints require /models/chat/completions.
            # Example endpoint in .env:
            ...
            if response.status_code == 404:
                return (
                    "Error communicating with Azure AI Foundry: Resource not found. "
                    f"Check endpoint and model name. endpoint={self.endpoint}, model={self.model_name}, "
                    "expected path suffix=/models/chat/completions"
                )
